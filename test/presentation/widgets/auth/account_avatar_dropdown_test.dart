...
import 'package:nai_launcher/presentation/widgets/auth/account_avatar_dropdown.dart';
...
void main() {
  testWidgets('头像下拉账号行展示到期信息：临期/已过期/无到期三态', (tester) async {
    ...
    await tester.pumpWidget(
      ProviderScope(
        ...
        child: const MaterialApp(
          ...
          home: Scaffold(body: AccountAvatarDropdown()),
        ),
      ),
    );
